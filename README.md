...
- [`reference/agent-workspace.md`](./reference/agent-workspace.md) — what `AGENTS.md`, `SOUL.md`, identity, user, memory, and budget files do, and how Cadre's bounded autonomy works.
