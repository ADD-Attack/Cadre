...
- [`reference/agent-workspace.md`](./reference/agent-workspace.md) — Michael Scott's replication guide: direct Markdown downloads, `AGENTS.md` / `SOUL.md` wiring, adoption steps, and a profile of the deployment.
